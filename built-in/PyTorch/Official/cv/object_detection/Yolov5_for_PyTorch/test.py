...
def test(data,
    ...
    if training:  # called by train.py
        ...
        device = torch_utils.select_device(opt.device, opt.npu, batch_size=batch_size)
    ...
    if save_json and len(jdict):
        ...
        try:  # https://github.com/cocodataset/cocoapi/blob/master/PythonAPI/pycocoEvalDemo.ipynb
            ...
            cocoGt = COCO(glob.glob(opt.coco_instance_path)[0])  # initialize COCO ground truth api
...
if __name__ == '__main__':
    ...
    parser.add_argument('--coco_instance_path', type=str, help='*.data path')
