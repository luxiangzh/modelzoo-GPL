...
nohup python3 -u train.py --data ./data/coco.yaml --cfg ./models/yolov5s.yaml --weights '' --batch-size $batch_size --device 0 --local_rank $ASCEND_DEVICE_ID --epochs 1 > ${cur_path}/test/output/$ASCEND_DEVICE_ID/train_perf_1p.log 2>&1 &
