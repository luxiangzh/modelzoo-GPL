...
def test(data,
    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader)):
        ...
        with torch.no_grad():
            ...
            t = time_synchronized()
            out = non_max_suppression(out, conf_thres=conf_thres, iou_thres=iou_thres, labels=lb, multi_label=True, batch_size=batch_size)
    ...
    if save_json and len(jdict):
        ...
        anno_json = opt.coco_path + '/annotations/instances_val2017.json'  # annotations json
