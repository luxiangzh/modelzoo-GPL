...
def save_one_txt(predn, save_conf, shape, file):
    ...
    for *xyxy, conf, cls in predn.tolist():
        ...
        with os.fdopen(os.open(file, flags, mdoe), "a") as f:
...
def run(data,
    ...
    if training:  # called by train.py
        ...
        device = select_device(device, local_rank, batch_size=batch_size)
    ...
    if save_json and len(jdict):
        ...
        mode = stat.S_IWUSR | stat.S_IRUSR
        with os.fdopen(os.open(pred_json, flags, mdoe), 'w') as f:
            json.dump(jdict, f)
