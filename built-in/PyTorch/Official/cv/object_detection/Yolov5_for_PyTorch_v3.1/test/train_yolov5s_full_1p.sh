...
#训练后进行eval显示精度
python3 test.py --data ./data/coco.yaml --img-size 640 --weight 'yolov5s.pt' --batch-size 128 --device $ASCEND_DEVICE_ID >> ${cur_path}/test/output/$ASCEND_DEVICE_ID/train_full_1p.log 2>&1 &
