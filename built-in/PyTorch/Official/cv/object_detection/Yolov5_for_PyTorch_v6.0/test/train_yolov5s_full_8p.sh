...
#训练后进行eval显示精度
python3.7 val.py --data ./data/coco.yaml --img-size 640 --weight 'yolov5_0.pt' --batch-size 256 --device 0 > ${cur_path}/test/output/$ASCEND_DEVICE_ID/train_acc_8p.log 2>&1 &
