...
python3 val.py --data ./data/coco.yaml --img-size 640 --weight 'yolov5_0.pt' --batch-size ${batch_size} --device 0 > ${cur_path}/test/output/$ASCEND_DEVICE_ID/train_eval_1p.log 2>&1 &
