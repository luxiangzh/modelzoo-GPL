...
python3 -u train.py --data ./data/coco.yaml --cfg yolov5s.yaml --weights '' --batch-size $batch_size --device 0 --epochs 1 --perf > ${cur_path}/test/output/$ASCEND_DEVICE_ID/train_perf_1p.log 2>&1 &
